                    ...
                    <v-col cols="12" sm="8" md="6" lg="5">
                        <v-card rounded="xl" elevation="6" class="pa-2">
                            ...
                            <v-card-actions class="flex-column px-6 pb-6 ga-3">
                                <v-btn block variant="tonal" color="primary" size="large" rounded="lg" :loading="isSubmitting" @click="register">完成填寫並送出</v-btn>
                                <v-btn block variant="outlined" color="primary" size="large" rounded="lg" @click="window.location.href = '/login'">返回登入頁</v-btn>
                            </v-card-actions>
                        </v-card>
                    </v-col>
                </v-row>
